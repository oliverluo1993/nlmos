...
Localized orbitals are widely used to visualize chemical bonding between atoms and thus help classify bonds and understand electronic-structure origins of observed properties of atomistic systems~\cite{RZK}. 
...
Localized orbitals are known as localized molecular orbitals (LMOs) in the field of molecular quantum chemistry and maximally localized Wannier functions (MLWFs) in solid state physics and materials science. 
...
% RZK: are we using the same value 
