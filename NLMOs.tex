...
\caption{The relationship between the orbital spread and Pipek-Mezey localization functional with -log(det($\sigma$)) of the Berghold NLMOs (blue line) and Pipek-Mezey NLMOs (orange line) of graphene system.}
