...
%* In order to generate localized orbitals while avoiding linear dependence between them, all existing methods impose either unitary or fixed-center constraints on orbital transformations during the localization procedure. 
