...
%RZK: Move to restuls. Discuss why this threshold is taken. For all systems, we chose the final determinant cutoff as 0.09~a.u., so we dismiss all generated NLMOs with final determinant less than 0.09 to prevent orbitals from collapsing.
