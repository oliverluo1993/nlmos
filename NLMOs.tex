...
The localization procedure was implemented in the CP2K software package~\cite{cp2kgeneral, kuhne2020cp2k}. The DBCSR library~\cite{borvstnik2014sparse} that handles sparse matrices efficiently on massively-parallel computing platforms is utilized to enable orbital localization in large systems.
