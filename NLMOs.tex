...
\caption{A plot of the OLMO and NLMO of the $\sigma$ bond~(second column) and $\pi$ bond~(third and forth column) in graphene. (isosurface value equals to  0.05~a.u.)}
\label{fig:pipek}
\end{figure*}
...
According to the first row in the Figure~\ref{fig:pipek}, our results maintain the $\sigma$ and $\pi$ separation in OLMOs, which are illustrated the $\pi$ bond in benzene molecule and perfectly separated $\sigma$ and $\pi$ bond of propenol molecule.
